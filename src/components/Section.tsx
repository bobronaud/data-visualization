...
const Section = ({ data }: Props) => {
  return (
    <>
      ...
      <div className="body">
        <Instance data={data.dev} />
        <Instance data={data.prod} />
        <Instance data={data.test} />
      </div>
      <div className="captions">
        <div className="caption-client">Клиентская часть</div>
        <div className="caption-server">Серверная часть</div>
        <div className="caption-db">База данных</div>
      </div>
    </>
  );
};
